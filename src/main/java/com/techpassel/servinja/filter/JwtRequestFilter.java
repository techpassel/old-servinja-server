package com.techpassel.servinja.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(authHeader != null && authHeader.startsWith("Bearer ")){
            ...
            username = jwtUtil.extractUsername(jwt);    //To get the username from token extracted in previous step.
        }
        ...
        //Finally we are passing the request and response to next filter in the process
